...
1. **损失函数**量化模型"有多差"，**正则化**控制模型复杂度
2. **AdamW** 是当前推荐默认优化器
3. **学习率是最重要的超参数**，推荐 warmup + cosine decay
4. 始终在验证集上调参，测试集只在最后使用一次

---

*笔记整理自 [CS231n Spring 2025 Lecture 3](https://youtu.be/PTypu6GqEd4?list=PLoROMvodv4rOmsNzYBMe0gJY2XS8AQg16) 及课程资料*
