...
1. **将集群视为一台巨型计算机** — 为内存/通信层级设计算法
2. **理解硬件:** HBM → NVLink → 跨 Pod 带宽下降决定策略选择
3. **渐进扩展:** DP → FSDP → HSDP → TP/PP/CP
4. **Activation Checkpointing** 对大模型至关重要 — 用 √N 个 checkpoint
5. **MFU 是指北星指标** — 以 >30% 为目标, >40% 为优秀
6. 生产中将**四轴并行结合使用**

---

*笔记整理自 [CS231n Spring 2025 Lecture 11](https://youtu.be/PTypu6GqEd4?list=PLoROMvodv4rOmsNzYBMe0gJY2XS8AQg16) 及课程资料*
