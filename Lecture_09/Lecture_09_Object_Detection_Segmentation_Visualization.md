# CS231n (Spring 2025) — Lecture 9: Object Detection, Image Segmentation, Visualizing
...
1. [Transformer 基础回顾](#1-transformer-基础回顾)
2. [Vision Transformer (ViT)](#2-vision-transformer-vit)
3. [Transformer 架构优化技巧](#3-transformer-架构优化技巧)
4. [计算机视觉核心任务总览](#4-计算机视觉核心任务总览)
5. [语义分割 (Semantic Segmentation)](#5-语义分割-semantic-segmentation)
6. [全卷积网络 (FCN)](#6-全卷积网络-fcn)
7. [UNet 架构](#7-unet-架构)
8. [转置卷积 (Transpose Convolution)](#8-转置卷积-transpose-convolution)
9. [目标检测 (Object Detection)](#9-目标检测-object-detection)
10. [R-CNN 系列演进](#10-r-cnn-系列演进)
11. [区域提议网络 (RPN)](#11-区域提议网络-rpn)
12. [单阶段检测器 (YOLO)](#12-单阶段检测器-yolo)
13. [DETR (Detection Transformer)](#13-detr-detection-transformer)
14. [实例分割: Mask R-CNN](#14-实例分割-mask-r-cnn)
15. [可视化与可解释性](#15-可视化与可解释性)
16. [核心要点总结](#16-核心要点总结)
...
*笔记整理自 [CS231n Spring 2025 Lecture 9](https://youtu.be/PTypu6GqEd4) 及 [课程笔记参考](https://tuananhbui89.github.io/blog/2025/cs231n-2025-lec09/)*
