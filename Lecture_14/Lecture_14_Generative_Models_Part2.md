# CS231n (Spring 2025) — Lecture 14: Generative Models (Part 2 — Diffusion Models)
...
1. **Rectified Flow** 是最简洁的入口 — 直线插值 + 速度预测 + Euler 采样
2. **CFG** 是高质量条件生成的**关键实用技巧**
3. **噪声调度很重要** — 中等噪声水平最难，需要强调
4. **隐空间扩散**是扩展到高分辨率的标准
5. **DiT (Transformer)** 已在大规模模型中取代 U-Net
6. **蒸馏**是通向实时生成的道路
7. 所有扩散变体在数学上统一于一个模板

---

*笔记整理自 [CS231n Spring 2025 Lecture 14](https://youtu.be/PTypu6GqEd4?list=PLoROMvodv4rOmsNzYBMe0gJY2XS8AQg16) 及课程资料*
